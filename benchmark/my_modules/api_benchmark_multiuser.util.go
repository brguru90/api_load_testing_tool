...
func BenchmarkAPIAsMultiUser(
	...
	var all_concurrent_iteration_wg,iteration_wg2, rh_iteration_wg sync.WaitGroup
	var i, j int64
	...
	all_concurrent_iteration_wg.Add(int(number_of_iteration))
	for i = 0; i < number_of_iteration; i++ {
		iteration_wg2.Add(1)
		go func(_i int64) {
			defer all_concurrent_iteration_wg.Done()
	...
	all_concurrent_iteration_wg.Wait()
